      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        <ScrollView contentContainerStyle={{ padding: 20, gap: 22, paddingBottom: 48 }}
          ...
          <View style={{ flexDirection: 'row', gap: 12 }}>
            ...
            <StatTile icon="calendar" color={t.colors.success} value={String(d.weekWorkouts)} label="Semaine" />
            <StatTile icon="trophy" color={t.colors.warning} value={String(d.recentPRs.length)} label="Records" />
          </View>

          {/* WEEK STRIP */}
          <Widget title="Ta semaine" right={`${d.last7.filter((x) => x.trained).length} / 7`}>

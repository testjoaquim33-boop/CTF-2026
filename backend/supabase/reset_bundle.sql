-- ============================================================================
-- PROJECT_FIT — RESET + INSTALLATION (Supabase SQL Editor)
-- ⚠️  DESTRUCTIF : supprime et recrée le schéma 'public' (toutes les tables/
--     données applicatives). À utiliser sur un projet NEUF, ou pour repartir
--     proprement après une installation interrompue. NE PAS lancer sur une
--     base contenant des données à conserver.
--     N'affecte PAS les schémas Supabase (auth, storage, ...).
-- ============================================================================

begin;

-- --- RESET : nettoie tout état partiel d'une tentative précédente ---

...
-- Schéma (0001) + RLS (0002) + provisioning (0003) + seed (core + 52 exercices).
-- Sur un vrai projet Supabase, auth.users / auth.uid() / les rôles existent déjà.
-- Enveloppé dans une transaction : en cas d'erreur, TOUT est annulé (pas d'état partiel).
-- À exécuter UNE fois sur une base neuve. Seed idempotent (on conflict do nothing).
-- ============================================================================
